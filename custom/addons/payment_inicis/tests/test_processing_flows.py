...
from odoo.addons.payment_inicis.controllers.main import InicisController
from odoo.addons.payment_inicis.tests.common import AsiaPayCommon
...
class TestProcessingFlows(AsiaPayCommon, PaymentHttpCommon):
    ...
    def test_webhook_notification_triggers_processing(self):
        ...
        url = self._build_url(InicisController._webhook_url)
        with patch(
            'odoo.addons.payment_inicis.controllers.main.AsiaPayController.'
    ...
    @mute_logger('odoo.addons.payment_inicis.controllers.main')
